...
<ul>
    ...
    <li><div><span class="disabled">{'Metatags'|i18n( 'design/admin/parts/setup/menu' )}</span></div></li>
...
<ul>
    ...
    <li><div><a href={'/metatags/classlist/'|ezurl}>{'Metatags'|i18n( 'design/admin/parts/setup/menu' )}</a></div></li>
